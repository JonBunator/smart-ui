...
export type SmartButtonProps = React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> & SmartButtonElementProps;
...
const SmartButton = forwardRef<HTMLButtonElement, SmartButtonProps>((props, ref) => {
    ...
    return (
      <SmartComponent id={id} label={extractTextFromNode(children)} semantic={smartSemantic} type="button" smartOnChange={clickButton} updateAfterApproval={true} href={smartHref}>
